 ...
 *
 * This is a heuristic pre-pass, not an AI extractor. It gives the profile
 * engine a strong starting point; anything it gets wrong is meant to be
 * corrected in the profile editor. The AI-backed extraction path lives in
 * @veya/ai (@veya/prompts buildProfileExtractionPrompt) and is not used here.
 */
